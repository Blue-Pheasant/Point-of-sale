...
ALTER TABLE order_detail ADD id varchar(100) NOT NULL;

delete from cart_detail;
ALTER TABLE cart_detail ADD order_detail_id varchar(100) NOT NULL;

SELECT * FROM products WHERE id = '5b03966a1acd4d5bbd672374';
