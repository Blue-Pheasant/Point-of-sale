...
class m0001_initial
{
    public function up()
    {
        ...
        $sql = "
            ...
            `image_url` varchar(4000) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
            `address` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
            `ward_id` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
            `district_id` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
            `province_id` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
